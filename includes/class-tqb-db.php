...
class TQB_Database {
	...
	public function count_user_answers( $user_id, $quiz_id, $filters = array() ) {
		...
		$where = " AND ua.quiz_id = {$quiz_id} AND ua.user_id = {$user_id}";
	...
	public function get_questions_report_data( $quiz_id ) {
		...
		question.text AS question_text, question.views AS question_views, answer.text AS answer_text, answer.image AS answer_image  ';
